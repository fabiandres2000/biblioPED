...
<body class="vertical-layout vertical-menu 2-columns menu-expanded fixed-navbar" data-open="click"
                                ...
                                <div class="card border-grey border-lighten-3 px-1 py-1 m-0" style="box-shadow: none">
                                    <div class="card-header border-0">
                                        <div class="card-title text-center">
                                            <img src="{{ asset('img/logo_1.png') }}" style="height: 90px;" alt="branding logo">
                                        </div>
                                        ...
                                        <div class="card-body">
                                            <form class="form-horizontal" id="miFormulario" method="POST" validate>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-6 col-12 float-sm-left text-center text-sm-right"><a href="recover-password.html" class="card-link">Has olvidado tu contraseña?</a></div>
                                                </div>
                                            </form>
                                        </div>
                                        <div class="card-body" style="display: flex; padding: 0.5rem; justify-content: space-between;">
                                            <button style="width: 48%" id="btnLogin" class="btn btn-outline-success btn-block"><i class="feather icon-user"></i> Iniciar Sesión</button>
                            ...
                            <div class="col-lg-12 col-md-8 col-10  p-0">
                                <div class="card border-grey border-lighten-3 px-1 py-1 m-0" style="box-shadow: none">
                                    ...
                                    <div class="card-content">
                                            ...
                                            <form class="form-horizontal" id="miFormulario2" method="POST" validate>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-1" style="padding-top: 4px">
                                                        <div class="avatar">
                                                            <img style="width: 155%; max-width: 154%;" data-toggle="modal" data-target="#modal_avatar" id="imagen_avatar" src="{{ asset('avatars/default.png') }}" alt="avatar">
                                                            <i></i>
                                                        </div>
                                                    </div>
                                                </div>
                                               ...
                                               <hr>
                                                <div class="form-group row">
                                                    <div class="col-sm-6 col-12 text-center text-sm-left pr-0">
                                                        <fieldset>
                                                            <input type="checkbox" id="remember-me2" class="chk-remember">
                                        ...
                                        <div class="card-body" style="display: flex; padding: 0.5rem; justify-content: space-between;">
                                            <button style="width: 48%" id="btnRegistrar" class="btn btn-outline-success btn-block"><i class="feather icon-user"></i> Registrate</button>
                                            <button data-dismiss="modal" aria-label="Close" style="width: 48%; margin: 0" class="btn btn-outline-danger btn-block"><i class="feather icon-x"></i> Cancelar</button>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="modal fade text-left" id="modal_avatar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel17" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="base-tab1" data-toggle="tab" aria-controls="tab1" href="#tab1" role="tab" aria-selected="true">Primaria</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="base-tab2" data-toggle="tab" aria-controls="tab2" href="#tab2" role="tab" aria-selected="false">Secundaria</a>
                        </li>
                    </ul>
                    <div class="tab-content px-1 pt-1">
                        <div class="tab-pane active" id="tab1" role="tabpanel" aria-labelledby="base-tab1">
                            <div class="row">
                                <div class="col-3"><img class="img_avatar_sel" onclick="asignarURL('avatars/1.png')" src="{{ asset('avatars/1.png') }}" alt="1.png"></div>
                                <div class="col-3"><img class="img_avatar_sel" onclick="asignarURL('avatars/2.png')" src="{{ asset('avatars/2.png') }}" alt="1.png"></div>
                                <div class="col-3"><img class="img_avatar_sel" onclick="asignarURL('avatars/3.png')" src="{{ asset('avatars/3.png') }}" alt="1.png"></div>
                                <div class="col-3"><img class="img_avatar_sel" onclick="asignarURL('avatars/4.png')" src="{{ asset('avatars/4.png') }}" alt="1.png"></div>
                            </div>
                            <div class="row">
                                <div class="col-3"><img class="img_avatar_sel" onclick="asignarURL('avatars/5.png')" src="{{ asset('avatars/5.png') }}" alt="1.png"></div>
                                <div class="col-3"><img class="img_avatar_sel" onclick="asignarURL('avatars/6.png')" src="{{ asset('avatars/6.png') }}" alt="1.png"></div>
                                <div class="col-3"><img class="img_avatar_sel" onclick="asignarURL('avatars/7.png')" src="{{ asset('avatars/7.png') }}" alt="1.png"></div>
                                <div class="col-3"><img class="img_avatar_sel" onclick="asignarURL('avatars/8.png')" src="{{ asset('avatars/8.png') }}" alt="1.png"></div>
                            </div>
                            <div class="row">
                                <div class="col-3"><img class="img_avatar_sel" onclick="asignarURL('avatars/9.png')" src="{{ asset('avatars/9.png') }}" alt="1.png"></div>
                                <div class="col-3"><img class="img_avatar_sel" onclick="asignarURL('avatars/10.png')" src="{{ asset('avatars/10.png') }}" alt="1.png"></div>
                                <div class="col-3"><img class="img_avatar_sel" onclick="asignarURL('avatars/11.png')" src="{{ asset('avatars/11.png') }}" alt="1.png"></div>
                                <div class="col-3"><img class="img_avatar_sel" onclick="asignarURL('avatars/12.png')" src="{{ asset('avatars/12.png') }}" alt="1.png"></div>
                            </div>
                            <div class="row">
                                <div class="col-3"><img class="img_avatar_sel" onclick="asignarURL('avatars/13.png')" src="{{ asset('avatars/13.png') }}" alt="1.png"></div>
                                <div class="col-3"><img class="img_avatar_sel" onclick="asignarURL('avatars/14.png')" src="{{ asset('avatars/14.png') }}" alt="1.png"></div>
                                <div class="col-3"><img class="img_avatar_sel" onclick="asignarURL('avatars/15.png')" src="{{ asset('avatars/15.png') }}" alt="1.png"></div>
                                <div class="col-3"><img class="img_avatar_sel" onclick="asignarURL('avatars/16.png')" src="{{ asset('avatars/16.png') }}" alt="1.png"></div>
                            </div>
                            <div class="row">
                                <div class="col-3"><img class="img_avatar_sel" onclick="asignarURL('avatars/17.png')" src="{{ asset('avatars/17.png') }}" alt="1.png"></div>
                                <div class="col-3"><img class="img_avatar_sel" onclick="asignarURL('avatars/18.png')" src="{{ asset('avatars/18.png') }}" alt="1.png"></div>
                                <div class="col-3"><img class="img_avatar_sel" onclick="asignarURL('avatars/19.png')" src="{{ asset('avatars/19.png') }}" alt="1.png"></div>
                                <div class="col-3"><img class="img_avatar_sel" onclick="asignarURL('avatars/20.png')" src="{{ asset('avatars/20.png') }}" alt="1.png"></div>
                            </div>                        </div>
                        <div class="tab-pane" id="tab2" role="tabpanel" aria-labelledby="base-tab2">
                            <div class="row">
                                <div class="col-4 colavatar"><img class="img_avatar_sel" onclick="asignarURL('avatars/21.png')" src="{{ asset('avatars/21.png') }}" alt="1.png"></div>
                                <div class="col-4 colavatar"><img class="img_avatar_sel" onclick="asignarURL('avatars/22.png')" src="{{ asset('avatars/22.png') }}" alt="1.png"></div>
                                <div class="col-4 colavatar"><img class="img_avatar_sel" onclick="asignarURL('avatars/23.png')" src="{{ asset('avatars/23.png') }}" alt="1.png"></div>
                            </div>
                            <div class="row">
                                <div class="col-4 colavatar"><img class="img_avatar_sel" onclick="asignarURL('avatars/24.png')" src="{{ asset('avatars/24.png') }}" alt="1.png"></div>
                                <div class="col-4 colavatar"><img class="img_avatar_sel" onclick="asignarURL('avatars/25.png')" src="{{ asset('avatars/25.png') }}" alt="1.png"></div>
                                <div class="col-4 colavatar"><img class="img_avatar_sel" onclick="asignarURL('avatars/26.png')" src="{{ asset('avatars/26.png') }}" alt="1.png"></div>
                            </div>
                            <div class="row">
                                <div class="col-4 colavatar"><img class="img_avatar_sel" onclick="asignarURL('avatars/27.png')" src="{{ asset('avatars/27.png') }}" alt="1.png"></div>
                                <div class="col-4 colavatar"><img class="img_avatar_sel" onclick="asignarURL('avatars/28.png')" src="{{ asset('avatars/28.png') }}" alt="1.png"></div>
                                <div class="col-4 colavatar"><img class="img_avatar_sel" onclick="asignarURL('avatars/29.png')" src="{{ asset('avatars/29.png') }}" alt="1.png"></div>
                            </div>
                            <div class="row">
                                <div class="col-4 colavatar"><img class="img_avatar_sel" onclick="asignarURL('avatars/30.png')" src="{{ asset('avatars/30.png') }}" alt="1.png"></div>
                                <div class="col-4 colavatar"><img class="img_avatar_sel" onclick="asignarURL('avatars/31.png')" src="{{ asset('avatars/31.png') }}" alt="1.png"></div>
                                <div class="col-4 colavatar"><img class="img_avatar_sel" onclick="asignarURL('avatars/32.png')" src="{{ asset('avatars/32.png') }}" alt="1.png"></div>
                            </div>
                            <div class="row">
                                <div class="col-4 colavatar"><img class="img_avatar_sel" onclick="asignarURL('avatars/33.png')" src="{{ asset('avatars/33.png') }}" alt="1.png"></div>
                                <div class="col-4 colavatar"><img class="img_avatar_sel" onclick="asignarURL('avatars/34.png')" src="{{ asset('avatars/34.png') }}" alt="1.png"></div>
                                <div class="col-4 colavatar"><img class="img_avatar_sel" onclick="asignarURL('avatars/35.png')" src="{{ asset('avatars/35.png') }}" alt="1.png"></div>
                            </div>     
                        </div>
                    </div>
                </div>
